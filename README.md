# A simple, vibcoded, PhotoBooth composer for Mac,
...
Uses an image (preferable PNG) for the background
The recomended background size is 1566x4974, could be smaller, could be bigger
